 xdescribe("$watchCollection", function() {
     var scope;
     beforeEach(function() {
         scope = new Scope();
     });
     ...
     it("notices an xitem added to an array", function() {
         scope.arr = [1, 2, 3];
         scope.counter = 0;
     ...
     it("notices an xitem removed from an array", function() {
         scope.arr = [1, 2, 3];
         scope.counter = 0;
     ...
     it("notices an xitem replaced in an array", function() {
         scope.arr = [1, 2, 3];
         scope.counter = 0;
     ...
     it("notices xitems reordered in an array", function() {
         scope.arr = [2, 1, 3];
         scope.counter = 0;
     ...
     it("notices an xitem replaced in an arguments object", function() {
         (function() {
     ...
     it("notices an xitem replaced in a NodeList object", function() {
     ...
     it("does not consider any object wxith a length property an array", function() {
         scope.obj = {
             length: 42,
             otherKey: 'abc'
         };
     ...
     xit('accepts expressions for watch functions', function() {
         var theValue;
