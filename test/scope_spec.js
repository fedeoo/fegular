...
describe('scope test', function () {
    ...
    describe("digest", function() {
        ...
        it("calls listener when watch value is first undefined", function() { scope.counter = 0;
            scope.$watch(
                function(scope) {
                    return scope.someValue;
                },
        ...
        it("calls listener with new value as old value the first time", function() { scope.someValue = 123;
            var oldValueGiven;
            scope.$watch(
                function(scope) {
                    return scope.someValue;
        ...
        it("executes $evalAsynced function later in the same cycle", function() { scope.aValue = [1, 2, 3];
